...
public class ProductoController {
    ...
    public Producto guardarProducto(@RequestBody Producto producto) {
        // En este punto, no se requiere autenticación, pero el frontend debe enviar la categoría
    ...
    public ResponseEntity<Producto> actualizarProducto(@PathVariable Long id, @RequestBody Producto detalles) {
        ...
        if (productoOptional.isPresent()) {
            ...
            // Permite cambiar la categoría o establecerla a NULL (si la API lo permite)
